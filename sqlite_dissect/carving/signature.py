        ...
        if isinstance(master_schema_entry, VirtualTableRow):
            ...
            for version_number in range(self.parser_starting_version_number,
                ...
                if b_tree_updated:
                    ...
                    for cell_md5_hex_digest, record in iteritems(records):
            ...
            for serial_type_signature, table_row_signature in iteritems(self.table_row_signatures):
            ...
            if self.table_row_signatures:
                ...
                for table_row_md5_hex_digest, table_row_signature in iteritems(self.table_row_signatures):
                ...
                for table_row_column_index, table_row_column_serial_type_array in iteritems(table_row_columns):
...
class TableColumnSignature(object):
    ...
    def __init__(self, index, name, column_signatures):
        ...
        for column_signature_index, column_signature in iteritems(self.column_signatures):
...
class ColumnReducedVariableLengthSignature(ColumnVariableLengthSignature):
    ...
    def update(self, serial_type, count=None, variable_length_serial_types=None):
        ...
        for variable_length_serial_type, variable_length_serial_type_count in iteritems(variable_length_serial_types):
